...
def CNN_model() :
    ...
    if GL == 'LSTM' :
        ...
        T1 = TimeDistributed(Conv2D(32,(3,3), strides=(1,1), activation='elu'))(I)
        T2 = TimeDistributed(Flatten())(T1)
        B1 = wrappers.Bidirectional(GRU(39, activation='elu', dropout=0.0, return_sequences=True), merge_mode='concat', weights=None)(T2)
        B4 = wrappers.Bidirectional(GRU(96, activation='elu', dropout=dr_r, return_sequences=True), merge_mode='concat', weights=None)(B1)
